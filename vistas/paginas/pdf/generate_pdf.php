...
$usuariosJSON = $_GET['usuarios'];
$usuariosFiltrados = json_decode($usuariosJSON, true);  // Decodificar JSON a array
// Recibir el token de la URL
    ...
    $pdf->SetTitle('Reporte | TODOS LOS REGISTROS');
    ...
    $html = '
        ...
        <h3>Reporte de Todas las Personas</h3>
        <br><br>
    ';
