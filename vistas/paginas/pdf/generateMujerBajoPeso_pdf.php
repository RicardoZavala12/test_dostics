...
require_once $formulariosModeloPath;
    ...
    $pdf->SetTitle('Reporte | MUJERES CON BAJO PESO');
    ...
    $html = '
        ...
        <h3>Reporte de Personas "MUJERES CON BAJO PESO"</h3>
        <br><br>
    ';
    ...
    $html.='
        ...
        <table>
            ...
            foreach ($usuarios as $row) {
                if ($row['nivel_peso'] === 'BAJO PESO' AND $row['sexo'] === 'FEMENINO') {
    ...
    $pdf->Output('RT_mujerbajopeso.pdf', 'I');
